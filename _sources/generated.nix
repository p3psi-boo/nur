...
}:
{
  ...
  bichon = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1.4.1";
      fetchSubmodules = false;
      sha256 = "sha256-EfFBZDKIkdAV7g4jjO0vHKRLItRJjIcArMIYcFUQW/Q=";
    };
  };
  binsider-bin = {
    pname = "binsider-bin";
  ...
  cliproxyapi = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v7.1.28";
      fetchSubmodules = false;
      sha256 = "sha256-HC2McUg4agl85Cju20aDNR0iSWPrD5c/f0DxUo86fsM=";
    };
  };
  cocoindex-code = {
  ...
  codex-desktop-linux = {
    ...
    version = "0142eb191eb589a9d8377a87222675d4a8e02ac3";
    src = fetchgit {
      url = "https://github.com/ilysenko/codex-desktop-linux.git";
      rev = "0142eb191eb589a9d8377a87222675d4a8e02ac3";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-N20qkBc5Z47c5PKxWFn5XR+EgVw3Ok4WAl9ktsxCTTY=";
    };
    date = "2026-05-28";
  };
  coe = {
  ...
  copilot-api-plus = {
    ...
    version = "0350e8805456b2c14e12358db66ae0584a5cc4ac";
    src = fetchgit {
      url = "https://github.com/imbuxiangnan-cyber/copilot-api-plus.git";
      rev = "0350e8805456b2c14e12358db66ae0584a5cc4ac";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-TEROakqOoE2jRa4taSZ5mYmDAIjy5otYQ2aJniyFzz8=";
    };
    date = "2026-05-24";
  };
  dagu = {
  ...
  ida-mcp = {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-tm5DqW2TfNR6t0VFrhAYSd4TySN4by8PPO2mCZwWa8M=";
    };
  };
  ida-pro-mcp = {
    pname = "ida-pro-mcp";
  ...
  komari = {
    pname = "komari";
    version = "567d2b66fb5d05545abd89a2843f1c7c94e8fff4";
    src = fetchgit {
      url = "https://github.com/komari-monitor/komari.git";
      rev = "567d2b66fb5d05545abd89a2843f1c7c94e8fff4";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
  ...
  komari-web = {
    ...
    src = fetchgit {
      ...
      rev = "d93e15719e6bea6a09bf223a00995bf1b147ddd3";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-m7nS/xSM+zNjMGviPZSne2nqekv5ymcFfrtUrEqsXJ4=";
    };
    date = "2026-05-07";
  };
  lazyssh = {
  ...
  lucebox-hub = {
    pname = "lucebox-hub";
    version = "43457d8fd188ed29dd38805978c91f726e1f7da1";
    src = fetchgit {
      url = "https://github.com/Luce-Org/lucebox-hub.git";
      rev = "43457d8fd188ed29dd38805978c91f726e1f7da1";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-wOSWCcellSbaNDO+TRoc73s2qiXPKNc+UB5VuF2ma9I=";
    };
    date = "2026-05-28";
  };
  magiskboot-bin = {
  ...
  mobilepi = {
    pname = "mobilepi";
    version = "c4d0fc36758e24deb6a14401626a99fad18c369c";
    src = fetchgit {
      url = "https://github.com/p3psi-boo/MobilePi.git";
      rev = "c4d0fc36758e24deb6a14401626a99fad18c369c";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-LXrhOQwPdfq+2nuAfm+CkcuhrYFVds2iDHjhOT2ybyQ=";
    };
    date = "2026-05-28";
  };
  n9router = {
  ...
  openalice = {
    pname = "openalice";
    version = "v0.21.0-beta.5";
    src = fetchFromGitHub {
      owner = "TraderAlice";
      repo = "OpenAlice";
      rev = "v0.21.0-beta.5";
      fetchSubmodules = false;
      sha256 = "sha256-q+bA/cl09mGev6LgWotX8/rCMdH/HESGYlC69aGuCOw=";
    };
  };
  openixcli = {
    pname = "openixcli";
    version = "c36f2443adf5aae9d11cfe4171666925523e5646";
    src = fetchgit {
      url = "https://github.com/YuzukiTsuru/OpenixCLI.git";
      rev = "c36f2443adf5aae9d11cfe4171666925523e5646";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-u+qzxHSgftJYjmvmOs8xWEMY+vSoR5jM83o1DFmSqnY=";
    };
    date = "2026-05-24";
  };
  oura-cli = {
  ...
  paperclip = {
    pname = "paperclip";
    version = "8da50dbcf8f98e82fb313c1fb023c13047d44bb6";
    src = fetchgit {
      url = "https://github.com/paperclipai/paperclip.git";
      rev = "8da50dbcf8f98e82fb313c1fb023c13047d44bb6";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-yHukboI46OJS5ppSPuU1OX6YRI1RRIbv8EcXoneKfgM=";
    };
    date = "2026-05-27";
  };
  pg_duckdb = {
  ...
  rustconn = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.15.0";
      fetchSubmodules = false;
      sha256 = "sha256-YUmjO/yJkVVqqfqopUdFOics7ADnntnh7ANMlO44Fw4=";
    };
  };
  selector4nix = {
    pname = "selector4nix";
  ...
  vllm = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.21.0";
      fetchSubmodules = false;
      sha256 = "sha256-lVgzo6R+l86IH5yxCtfJckVCP86jlgN7ufF5i0Pn2/A=";
    };
  };
  web-search = {
    pname = "web-search";
