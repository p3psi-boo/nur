...
}:
{
  ...
  cliproxyapi = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v6.9.5";
      fetchSubmodules = false;
      sha256 = "sha256-30C/NabUtbaRdZAtEKAWiOyavSbI2/xyh4CgAEDmN2A=";
    };
  };
  cloudflarespeedtest = {
  ...
  coe = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.0.9";
      fetchSubmodules = false;
      sha256 = "sha256-4kqxXYOd7UEQjO5Fzgzd5xXlY0igs0gX91mVGfpQjpg=";
    };
  };
  dagu = {
    pname = "dagu";
  ...
  liteparse = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.4.1";
      fetchSubmodules = false;
      sha256 = "sha256-8sTvE8akRbiJ5GjXQCzmVAYdTD8j8OoSANkbkV6TJ5Y=";
    };
  };
  magiskboot-bin = {
