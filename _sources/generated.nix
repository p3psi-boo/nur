...
}:
{
  agsh = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-B0Wu/XlpKTzr3VQKeZfqqoPtUeISrNxq2XzgVlmKovc=";
    };
  };
  bb-browser = {
    pname = "bb-browser";
  ...
  dagu = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v2.6.10";
      fetchSubmodules = false;
      sha256 = "sha256-Jw3VnSKLJKMXiKq4bSVVMM4mwNzD6cFxS9M/WqukcDk=";
    };
  };
  dailyhot-api = {
    pname = "dailyhot-api";
  ...
  grdpwasm = {
    pname = "grdpwasm";
    version = "000bb57204c31043875517ea9a51b6dc606b504a";
    src = fetchgit {
      url = "https://github.com/nakagami/grdpwasm.git";
      rev = "000bb57204c31043875517ea9a51b6dc606b504a";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-WW7RYiOsSZuahgw2hBp4x1N2wOp23W2ktKKOKhkRcjk=";
    };
    date = "2026-05-16";
  };
  grok2api = {
  ...
  ida-mcp = {
    ...
    version = "9.3.20";
    src = fetchurl {
      url = "https://github.com/blacktop/ida-mcp-rs/releases/download/v9.3.20/ida-mcp_9.3.20_Linux_x86_64.tar.gz";
      sha256 = "sha256-Zb7I8M8xZF7YydSlLl97qCmBZgHPGaWXZo97idYLPEs=";
    };
  };
  ida-pro-mcp = {
    pname = "ida-pro-mcp";
  ...
  lucebox-hub = {
    pname = "lucebox-hub";
    version = "f230aaf55af7d7d069fb293481107cd7be49ed82";
    src = fetchgit {
      url = "https://github.com/Luce-Org/lucebox-hub.git";
      rev = "f230aaf55af7d7d069fb293481107cd7be49ed82";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-1JgZRsAiGPVmeo9DPl7L/Lrvg5WlwRDUNmkpWjZFn/w=";
    };
    date = "2026-05-16";
  };
  magiskboot-bin = {
  ...
  paperclip = {
    pname = "paperclip";
    version = "3e6610fb938d04638fa578a1fc0d119b434fa2e4";
    src = fetchgit {
      url = "https://github.com/paperclipai/paperclip.git";
      rev = "3e6610fb938d04638fa578a1fc0d119b434fa2e4";
      fetchSubmodules = false;
      deepClone = false;
      leaveDotGit = false;
      sparseCheckout = [ ];
      sha256 = "sha256-WgsyiEq/rEYk/RgU/p/dBYok1WdN4tZfWgQePJw6m08=";
    };
    date = "2026-05-16";
  };
  pg_duckdb = {
  ...
  rustconn = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.13.17";
      fetchSubmodules = false;
      sha256 = "sha256-u2J6JSZ/nb7Xids/KJaEMmAS20zeLK85xxofsWbRmcM=";
    };
  };
  selector4nix = {
    pname = "selector4nix";
